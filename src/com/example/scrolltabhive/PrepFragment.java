...
public class PrepFragment extends Fragment {
    ...
    private static final int DATE_DIALOG_ID = 9998;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_prep, container, false);
        init();
        return rootView;
    }
    ...
    private void init(){
        ...
        nm = (NotificationManager) getActivity().getSystemService(rootView.getContext().NOTIFICATION_SERVICE);
       // Intent intent = new Intent(this, PrepFragment.class);
       // pd = PendingIntent.getActivity(PrepFragment.this, 0, intent, 0);
        */
    }
    ...
    public void setCurrentDateOnView() {
        ...
        /*
        tvDisplayTime = (TextView) rootView.findViewById(R.id.tvTime);
    ...
    public void addListenerOnButton_countdown() {
        button = (Button) rootView.findViewById(R.id.btnCountDown);
    ...
    private void generateBaseNotification(int ID, String title, String content) {
        ...
        baseNF.setLatestEventInfo(rootView.getContext(), title, content, pd);
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DATE_DIALOG_ID:
                ...
                return new DatePickerDialog(rootView.getContext(), datePickerListener,
                        year, month, day);
